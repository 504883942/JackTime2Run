...
namespace Demo2
{
    class Program
    {
        ...
        public void Show()
        {
            lock (typeof(Program))
            {
                File.AppendAllText("d:\\demo2.cs.Show().txt", "demo2.cs.Show()" + DateTime.Now.ToString
        ...
        public void Show(string[] args)
        {
            lock (typeof(Program))
            {
                ...
                File.AppendAllText("d:\\demo2.cs.Show(string[] args).txt", "demo2.cs.Show(string[] args)" + DateTime.Now.ToString
                    ("yyyy-MM-dd HH:mm:ss.fff") + para + "\r\n");
            }
        }
    }
